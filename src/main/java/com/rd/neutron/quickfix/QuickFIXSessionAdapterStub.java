 ...
 * @author gmiller
 *//*
@ClassVersion("$Id: QuickFIXSessionAdapterStub.java 16154 2012-07-14 16:34:05Z colin $") //$NON-NLS-1$
public class QuickFIXSessionAdapterStub implements NeutronQuickFIXApplication
{
