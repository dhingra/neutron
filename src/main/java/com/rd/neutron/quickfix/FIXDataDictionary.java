 ...
 *
 * @author Toli Kuznets
 * @version $Id: FIXDataDictionary.java 10112 2008-11-28 11:15:51Z tlerios $
 */
    ...
    public FIXDataDictionary(String fixDataDictionaryPath) throws FIXFieldConverterNotAvailable
    {
        ...
        try {
            ...
            try {
                ...
                throw new FIXFieldConverterNotAvailable(ddex, "ERROR_COULD_NOT_CREATE_FIX_DATA_DICTIONARY");
            }
        } catch (ConfigError configError) {
            throw new FIXFieldConverterNotAvailable(configError, "ERROR_COULD_NOT_CREATE_FIX_DATA_DICTIONARY");
        }
